    ...
    <div class="title">
        ...
        <div class="btns">
            <span>
                <Icon style="position: absolute;
                            top: 50%;
                            left: 30%;
                            transform: translateY(-50%);" type="ios-cash-outline" size="20" color="#fff"/>
            ...
            <span>
                <Icon style="position: absolute;
                            top: 50%;
                            left: 30%;
                            transform: translateY(-50%);" type="ios-cash" size="20" color="#fff"/>
                <button>提款</button>
            </span>
        </div>
    </div>
      <ul class="list">
          <li>
              ...
              <div @click="handleAlert('1','changePassword','修改密码')">
                  修改登录密码
              </div>
          </li>
          <li>
              ...
              <div @click="handleAlert('132','bank','绑定银行卡')">
                  绑定银行卡
              </div>
          </li>
          <li>
              ...
              <div @click="handleAlert('2','changePassword','提款密码')">
                  提款密码
              </div>
          </li>
          <li>
              ...
              <div @click="handleAlert('2','information','站内信')">
                  查看站内信
              </div>
          </li>
          <li>
              ...
              <div @click="handleAlert('2','bindquestion','密保设定')">
                  修改密码设定
              </div>
          </li>
          <li>
              ...
              <div @click="handleAlert('2','notice','系统公告')">
                  查看公告
              </div>
          </li>
      </ul>
